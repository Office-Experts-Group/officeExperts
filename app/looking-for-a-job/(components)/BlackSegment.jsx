      ...
      <AnimateOnScroll animation="slide-left" delay={0.1} duration={1.2}>
        <div className={styles.content}>
          <div className={styles.title}>
            ...
            <h2>We Await Your Expression of Interest!</h2>
          </div>
          <div className={`${styles.text} ${styles.center}`}>
            <p>
              If you are technically talented, good with people, business minded
              and self-motivated we would love for you to join our team of
              developers and programmers across Australia!
            </p>
