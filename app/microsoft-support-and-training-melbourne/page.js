...
const MelbourneSupportTraining = () => {
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          title="Microsoft Support and Training Melbourne"
          desktopImage={melbourne}
          mobileImage={melbourneMob}
          altDesk="Melbourne cityscape"
          altMob="Melbourne"
        />
        <section className={styles.supportPage}>
          <section className={styles.pageHeader}>
            <h2 className={styles.leadText}>
              ...
              and Training with local Melbourne Experts.
            </h2>
          </section>
          ...
          <section className={styles.pageSegment}>
            ...
            <AnimateOnScroll animation="slide-right" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our Melbourne Microsoft support team provides comprehensive
                  ...
                  Melbourne support team deliver prompt, expert solutions.
                </p>
          ...
          <Promo
            h2={"Melbourne's Trusted Microsoft Solutions Team"}
            p={
          ...
          <section className={`${styles.pageSegment} ${styles.lastSegment}`}>
            <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our customised Microsoft training programs help Melbourne
                  ...
                  Melbourne location or via remote sessions.
                </p>
          ...
          <section className={styles.conclusion}>
            <h2>Why Choose Local Microsoft Melbourne Support and Training?</h2>
            <p>
...
export default MelbourneSupportTraining;
