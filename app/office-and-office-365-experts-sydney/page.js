...
const schema = {
  ...
  "@graph": [
    ...
    ...getHomePageSchema(testimonials, "office")["@graph"],
    {
      ...
      description:
        "Leading Microsoft Office consultants in Sydney. Our experts specialise in custom Office development, integration, and business automation solutions.",
      isPartOf: {
...
const Page = () => {
  ...
  return (
    <>
      ...
      />
      <ServiceHero
        title={`Microsoft Office ${location}`}
        desktopImage={sydney}
