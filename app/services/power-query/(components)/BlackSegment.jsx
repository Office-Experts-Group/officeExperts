      ...
      <AnimateOnScroll animation="fade-down" delay={0.3} duration={1.2}>
        <div className={styles.points}>
          <div className={styles.point}>
            ...
            <strong>Data Connection & Integration -</strong> We connect Power Query to your ERP, CRM, or cloud-based systems to bring all your business data into one place — accurately and reliably.
            </p>
          </div>
          ...
          <div className={styles.point}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Data Transformation & Cleansing -</strong> From removing duplicates to standardising formats, we help you clean your data so you can trust the numbers and speed up your analysis.</p>
          </div>
          ...
          <div className={styles.point}>
            ...
            />
            <p className={styles.centerText}>
            <strong>Automation -</strong> Say goodbye to manual updates. We build automated workflows that refresh your data on a schedule, with built-in error handling to keep things running smoothly.</p>
          </div>
          ...
          <div className={styles.point} >
            ...
            />
            <p className={styles.centerText}>
            <strong>Data Modelling & Performance -</strong> Need to work with large datasets? We create scalable, efficient models that support fast analysis and future growth.</p>
          </div>
        </div>
      </AnimateOnScroll>
    </section>
