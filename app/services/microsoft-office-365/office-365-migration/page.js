...
const schema = {
  ...
  "@graph": [
    ...
    generateOrganizationSchema(),
    {
      ...
      name: "Office 365 Migration | Office 365 Upgrades | Office 365 Help | Office 365 Experts",
      isPartOf: {
      ...
      breadcrumb: {
        "@id":
          "https://www.officeexperts.com.au/services/microsoft-office-365/office-365-migration/#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
...
const Page = () => {
  return (
    <>
      ...
      />
      <ServiceHero
        title="Microsoft Office 365 Migration Consulting Services"
        desktopImage={pen}
        mobileImage={coffeeMob}
        altDesk={"pen pointing"}
        altMob={"coffee mug on a desk"}
      />
      <PageSegmentMain />
      <ExpertsAwait />
      <Contact />
