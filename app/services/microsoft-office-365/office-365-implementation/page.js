...
const schema = {
  ...
  "@graph": [
    ...
    generateOrganizationSchema(),
    {
      ...
      breadcrumb: {
        "@id":
          "https://www.officeexperts.com.au/services/microsoft-office-365/office-365-implementation#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 4,
          name: "Microsoft Office 365 Implementation",
        },
      ],
    },
  ],
...
const Page = () => {
  return (
    <>
      ...
      />
      <ServiceHero
        title="Microsoft Office 365 Implementation"
        desktopImage={support}
        mobileImage={teamMob}
        altDesk={"support team"}
        altMob={"team of office people"}
      />
      <PageSegmentMain />
      <ExpertsAwait />
      <Contact />
