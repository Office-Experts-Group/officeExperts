    ...
    >
      {isHidden ? (
        ...
        >
          ...
          <h3>Contents</h3>
          <a
            href="#why-choose-access"
            onClick={(e) => handleLinkClick(e, "#why-choose-access")}
          >
          ...
          <a
            href="#access-database-power"
            onClick={(e) => handleLinkClick(e, "#access-database-power")}
          >
            <div className={styles.contentLink}>
          ...
          <a
            href="#SQL-Server"
            onClick={(e) => handleLinkClick(e, "#SQL-Server")}
          >
            <div className={styles.contentLink}>
          ...
          <a
            href="#Visual-Studio-Databases"
            onClick={(e) => handleLinkClick(e, "#Visual-Studio-Databases")}
          >
            <div className={styles.contentLink}>
          ...
          <a
            href="#cloud-based-azure"
            onClick={(e) => handleLinkClick(e, "#cloud-based-azure")}
          >
            <div className={styles.contentLink}>
          ...
          <a
            href="#web-and-database"
            onClick={(e) => handleLinkClick(e, "#web-and-database")}
          >
            <div className={styles.contentLink}>
          ...
          <a
            href="#SharePoint-Solutions"
            onClick={(e) => handleLinkClick(e, "#SharePoint-Solutions")}
          >
            <div className={styles.contentLink}>
              <p>SharePoint Solutions</p>
            </div>
          </a>
          <a href="#ASP.net" onClick={(e) => handleLinkClick(e, "#ASP.net")}>
            <div className={styles.contentLink}>
