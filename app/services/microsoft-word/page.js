...
const schema = {
  ...
  "@graph": [
    ...getHomePageSchema(testimonials),
    {
      ...
      description:
        "We offer ongoing support and training, Microsoft Word services in Australia for your staff to learn specific tasks as required. Call us Today 1300 10 28 10",
      breadcrumb: {
        "@id":
