      ...
      <div className={styles.contentWrapper}>
        <AnimateOnScroll animation="fade-up" duration={1} delay={0.3}>
          <div className={styles.content}>
            ...
            <p>
              Our team of{" "}
              <Link href="https://www.wordexperts.com.au">Word designers</Link>{" "}
              can create your company documents and templates with our easy to
              use templates, complete with your branding, a consistent look and
              a professional feel.
            </p>
            <p>
