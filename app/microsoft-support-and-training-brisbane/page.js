...
const schemaData = {
  ...
  "@graph": [
    ...
    generateProfessionalServiceSchema(),
    {
      ...
      name: "Microsoft Support and Training Brisbane | Office Experts Group",
      isPartOf: {
...
const BrisbaneSupportTraining = () => {
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          title="Microsoft Support and Training Brisbane"
          desktopImage={brisbane}
          mobileImage={brisbaneMob}
          altDesk="Brisbane cityscape"
          altMob="Brisbane river and skyline"
        />
        <section className={styles.supportPage}>
          <section className={styles.pageHeader}>
            <h2 className={styles.leadText}>
              ...
              and Training with local Brisbane Experts.
            </h2>
          </section>
          ...
          <section className={styles.pageSegment}>
            ...
            <AnimateOnScroll animation="slide-right" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our Brisbane Microsoft support team provides comprehensive
                  ...
                  Brisbane support team deliver prompt, expert solutions.
                </p>
          ...
          <Promo
            h2={"Brisbane's Trusted Microsoft Solutions Team"}
            p={
          ...
          <section className={`${styles.pageSegment} ${styles.lastSegment}`}>
            <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our customised Microsoft training programs help Brisbane
                  ...
                  Brisbane location or via remote sessions.
                </p>
          ...
          <section className={styles.conclusion}>
            <h2>Why Choose Local Microsoft Brisbane Support and Training?</h2>
            <p>
              Working with our Brisbane-based Microsoft specialists ensures you
...
export default BrisbaneSupportTraining;
