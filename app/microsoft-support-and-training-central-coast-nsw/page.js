...
const CentralCoastSupportTraining = () => {
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          title="Microsoft Office Support & Personalised Training – Central Coast, NSW"
        ...
        <section className={styles.supportPage}>
          ...
          <section className={styles.conclusion}>
            <h2>
              Why Choose Local Microsoft Central Coast Support and Training?
            </h2>
            <p>
              Working with our Central Coast-based Microsoft specialists ensures
