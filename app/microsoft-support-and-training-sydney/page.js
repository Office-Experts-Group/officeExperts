...
const schemaData = {
  ...
  "@graph": [
    ...
    generateProfessionalServiceSchema(),
    {
      ...
      name: "Microsoft Support and Training Sydney | Office Experts Group",
      isPartOf: {
      ...
      breadcrumb: {
        "@id":
          "https://www.officeexperts.com.au/microsoft-support-and-training-sydney#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Microsoft Support and Training Sydney",
        },
      ],
    },
  ],
        ...
        <section className={styles.supportPage}>
          <section className={styles.pageHeader}>
            <h2 className={styles.leadText}>
              ...
              and Training with local Sydney Experts.
            </h2>
          </section>
          ...
          <section className={styles.pageSegment}>
            ...
            <AnimateOnScroll animation="slide-right" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our Sydney Microsoft support team provides comprehensive
                  ...
                  Sydney support team deliver prompt, expert solutions.
                </p>
          ...
          <Promo
            h2={"Sydney's Trusted Microsoft Solutions Team"}
            p={
          ...
          <section className={`${styles.pageSegment} ${styles.lastSegment}`}>
            <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our customised Microsoft training programs help Sydney
                  ...
                  Sydney location or via remote sessions.
                </p>
          ...
          <section className={styles.conclusion}>
            <h2>Why Choose Local Microsoft Sydney Support and Training?</h2>
            <p>
              Working with our Sydney-based Microsoft specialists ensures you
...
export default SydneySupportTraining;
