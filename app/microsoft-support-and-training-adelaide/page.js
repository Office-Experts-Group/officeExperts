    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Microsoft Support and Training Adelaide",
        },
      ],
    },
  ],
...
const AdelaideSupportTraining = () => {
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          title="Microsoft Support and Training Adelaide"
          desktopImage={adelaide}
          mobileImage={adelaideMob}
          altDesk="Adelaide cityscape"
          altMob="Adelaide"
        />
        <section className={styles.supportPage}>
          <section className={styles.pageHeader}>
            <h2 className={styles.leadText}>
              ...
              and Training with local Adelaide Experts.
            </h2>
          </section>
          ...
          <section className={styles.pageSegment}>
            ...
            <AnimateOnScroll animation="slide-right" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our Adelaide Microsoft support team provides comprehensive
                  ...
                  Adelaide support team deliver prompt, expert solutions.
                </p>
          ...
          <Promo
            h2={"Adelaide's Trusted Microsoft Solutions Team"}
            p={
          ...
          <section className={`${styles.pageSegment} ${styles.lastSegment}`}>
            <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our customised Microsoft training programs help Adelaide
                  ...
                  Adelaide location or via remote sessions.
                </p>
          ...
          <section className={styles.conclusion}>
            <h2>Why Choose Local Microsoft Adelaide Support and Training?</h2>
            <p>
              Working with our Adelaide-based Microsoft specialists ensures you
...
export default AdelaideSupportTraining;
