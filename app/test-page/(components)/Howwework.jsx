...
const reasons = [
  {
    ...
    body: "With over 25 consultants, designers and developers, we cover the full Microsoft stack without sending you to a different vendor for each product. Whether the answer is SharePoint, Power Platform, Azure or a custom web application, someone on our team has built it before.",
  },
  {
