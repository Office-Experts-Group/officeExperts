    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Microsoft Support and Training Wollongong",
        },
      ],
    },
  ],
...
const WollongongSupportTraining = () => {
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          title="Microsoft Support and Training Wollongong"
          desktopImage={wollongong}
          mobileImage={wollongongMob}
          altDesk="Wollongong cityscape"
          altMob="Wollongong"
        />
        <section className={styles.supportPage}>
          <section className={styles.pageHeader}>
            <h2 className={styles.leadText}>
              ...
              and Training with local Wollongong Experts.
            </h2>
          </section>
          ...
          <section className={styles.pageSegment}>
            ...
            <AnimateOnScroll animation="slide-right" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our Wollongong Microsoft support team provides comprehensive
                  ...
                  Wollongong support team deliver prompt, expert solutions.
                </p>
          ...
          <Promo
            h2={"Wollongong's Trusted Microsoft Solutions Team"}
            p={
          ...
          <section className={`${styles.pageSegment} ${styles.lastSegment}`}>
            <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our customised Microsoft training programs help Wollongong
                  ...
                  Wollongong location or via remote sessions.
                </p>
          ...
          <section className={styles.conclusion}>
            <h2>Why Choose Local Microsoft Wollongong Support and Training?</h2>
            <p>
              Working with our Wollongong-based Microsoft specialists ensures
...
export default WollongongSupportTraining;
