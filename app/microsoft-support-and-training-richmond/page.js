...
const schemaData = {
  ...
  "@graph": [
    ...
    generateProfessionalServiceSchema(),
    {
      ...
      url: "https://www.officeexperts.com.au/microsoft-support-and-training-richmond",
      name: "Microsoft Support and Training Richmond | Office Experts Group",
      isPartOf: {
      ...
      breadcrumb: {
        "@id":
          "https://www.officeexperts.com.au/microsoft-support-and-training-richmond#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Microsoft Support and Training Richmond",
        },
      ],
    },
  ],
...
const RichmondSupportTraining = () => {
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          title="Microsoft Support and Training Richmond"
        ...
        <section className={styles.supportPage}>
          <section className={styles.pageHeader}>
            <h2 className={styles.leadText}>
              ...
              and Training with local Richmond Experts.
            </h2>
          </section>
          ...
          <section className={styles.pageSegment}>
            ...
            <AnimateOnScroll animation="slide-right" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our Richmond Microsoft support team provides comprehensive
                  ...
                  Richmond support team deliver prompt, expert solutions.
                </p>
          ...
          <Promo
            h2={"Richmond's Trusted Microsoft Solutions Team"}
            p={
          ...
          <section className={`${styles.pageSegment} ${styles.lastSegment}`}>
            <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our customised Microsoft training programs help Richmond
                  ...
                  Richmond location or via remote sessions.
                </p>
          ...
          <section className={styles.conclusion}>
            <h2>Why Choose Local Microsoft Richmond Support and Training?</h2>
            <p>
              Working with our Richmond-based Microsoft specialists ensures you
...
export default RichmondSupportTraining;
