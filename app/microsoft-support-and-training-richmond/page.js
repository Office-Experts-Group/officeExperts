...
const schemaData = {
  ...
  "@graph": [
    ...
    generateProfessionalServiceSchema(),
    {
      ...
      description:
        "Professional Microsoft support and training services in Richmond. Our experts provide customised training, technical support and troubleshooting.",
      isPartOf: {
...
const RichmondSupportTraining = () => {
  ...
  return (
    <>
      ...
      <main>
        <ServiceHero
          title="Microsoft Office Support & Personalised Training – Richmond"
