...
const schemaData = {
  ...
  "@graph": [
    ...
    generateProfessionalServiceSchema(),
    {
      ...
      name: "Microsoft Support and Training Gold Coast | Office Experts Group",
      isPartOf: {
      ...
      breadcrumb: {
        "@id":
          "https://www.officeexperts.com.au/microsoft-support-and-training-gold-coast#breadcrumb",
      },
      inLanguage: "en-AU",
      potentialAction: [
        {
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          "@type": "ListItem",
          position: 3,
          name: "Microsoft Support and Training Gold Coast",
        },
      ],
    },
  ],
...
const GoldCoastSupportTraining = () => {
        ...
        <section className={styles.supportPage}>
          <section className={styles.pageHeader}>
            <h2 className={styles.leadText}>
              ...
              and Training with local Gold Coast Experts.
            </h2>
          </section>
          ...
          <section className={styles.pageSegment}>
            ...
            <AnimateOnScroll animation="slide-right" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our Gold Coast Microsoft support team provides comprehensive
                  ...
                  Gold Coast support team deliver prompt, expert solutions.
                </p>
          ...
          <Promo
            h2={"Gold Coast's Trusted Microsoft Solutions Team"}
            p={
          ...
          <section className={`${styles.pageSegment} ${styles.lastSegment}`}>
            <AnimateOnScroll animation="slide-left" duration={1} delay={0}>
              <div className={styles.contentWrapper}>
                ...
                <p>
                  Our customised Microsoft training programs help Gold Coast
                  ...
                  Gold Coast location or via remote sessions.
                </p>
          ...
          <section className={styles.conclusion}>
            <h2>Why Choose Local Microsoft Gold Coast Support and Training?</h2>
            <p>
              Working with our Gold Coast-based Microsoft specialists ensures
              you receive responsive, personalised service that understands
              local business needs. Our consultants are familiar with the unique
...
export default GoldCoastSupportTraining;
